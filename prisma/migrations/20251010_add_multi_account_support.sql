...
CREATE TABLE "Message_new" (
    ...
    CONSTRAINT "Message_replyToId_fkey" FOREIGN KEY ("replyToId") REFERENCES "Message_new" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
